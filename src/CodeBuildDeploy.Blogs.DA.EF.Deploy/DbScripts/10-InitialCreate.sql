...
('6181d9cc-ef13-42b3-aa66-ef2dc5b54fae', NULL, '09a8afe4-d726-43f6-9878-41ca1a4d5b39', N'ZeroBugs', N'It is impossible for software engineers to continuously produce bug-free, production ready code. Bugs will always exist. This article is about how we effectively handle such issues, acheiving a state of zero bugs backlog.', '2024-06-18T00:00:00.0000000', '2024-06-18T00:00:00.0000000', CAST(1 AS bit), N'Delete all the bugs from your backlog, now!', N'Zero Bugs', N'ZeroBugs'),
