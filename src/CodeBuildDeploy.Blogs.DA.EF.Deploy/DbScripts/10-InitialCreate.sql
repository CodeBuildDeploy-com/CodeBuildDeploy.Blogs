...
('d1ef2a8d-07bd-49cf-a785-a727567e9fc9', 'fc3cb34b-53c9-4342-a139-9ecf6b134008', N'WslAnsible', N'Read how to setup Ansible on Windows Subsystem for Linux, including setting up for seamlessly calling from windows powershell.', '2024-04-07T00:00:00.0000000', '2019-10-09T00:00:00.0000000', CAST(1 AS bit), N'Setting up Ansible on WSL', N'Ansible on WSL', N'WslAnsible');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Category_Id', N'Content', N'Description', N'Modified', N'PostedOn', N'Published', N'ShortDescription', N'Title', N'UrlSlug') AND [object_id] = OBJECT_ID(N'[blg].[Post]'))
