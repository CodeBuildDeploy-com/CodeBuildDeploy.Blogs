...
('26d005b9-5505-4646-9194-cd8358817ac8', 'fc3cb34b-53c9-4342-a139-9ecf6b134008', N'Tools', N'This section lists the tools I frequently use. Some are development tools others utility tools making general day to day working easier.', '2024-06-17T00:00:00.0000000', '2015-03-31T00:00:00.0000000', CAST(1 AS bit), N'My favourite software tools', N'Tools', N'Tools'),
...
('6181d9cc-ef13-42b3-aa66-ef2dc5b54fae', '09a8afe4-d726-43f6-9878-41ca1a4d5b39', N'ZeroBugs', N'It is impossible for developers to continuously produce bug-free, production ready code. Bugs will always exist. This article is about getting to a state of zero known bugs and that is absolutely possible.', '2024-06-18T00:00:00.0000000', '2024-06-18T00:00:00.0000000', CAST(1 AS bit), N'Delete all the bugs from your backlog, now!', N'Zero Bugs', N'ZeroBugs'),
('c5fecdc6-549a-41ce-ad63-fc8db2ab4e01', 'fc3cb34b-53c9-4342-a139-9ecf6b134008', N'MyShell', N'Having fun customizing my terminal and making my prompt look awesome, with Oh my Posh 3 and Nerd fonts.', '2024-06-10T00:00:00.0000000', '2024-06-10T00:00:00.0000000', CAST(1 AS bit), N'Having fun customizing my PowerShell terminal', N'Oh MY Shell', N'MyShell'),
...
('d1ef2a8d-07bd-49cf-a785-a727567e9fc9', 'fc3cb34b-53c9-4342-a139-9ecf6b134008', N'WslAnsible', N'Read how to setup Ansible on Windows Subsystem for Linux, including setting up for seamlessly calling from windows powershell.', '2024-06-07T00:00:00.0000000', '2019-10-09T00:00:00.0000000', CAST(1 AS bit), N'Setting up Ansible on WSL', N'Ansible on WSL', N'WslAnsible'),
('d8632d22-eb92-41a6-b3c4-dc1235846084', '09a8afe4-d726-43f6-9878-41ca1a4d5b39', N'DevOpsCLI', N'A container configured with all the CLI tools, scripts and extensions, a full stack DevOps cultured engineer needs for managing the AKS cluster instance.', '2024-06-18T00:00:00.0000000', '2024-06-18T00:00:00.0000000', CAST(1 AS bit), N'AKS CLI container for DevOps teams', N'AKS CLI container', N'devops-cli-aks');
IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'Category_Id', N'Content', N'Description', N'Modified', N'PostedOn', N'Published', N'ShortDescription', N'Title', N'UrlSlug') AND [object_id] = OBJECT_ID(N'[blg].[Post]'))
