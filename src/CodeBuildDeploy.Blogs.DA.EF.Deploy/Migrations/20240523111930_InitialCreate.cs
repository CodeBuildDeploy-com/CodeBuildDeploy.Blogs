        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("6181d9cc-ef13-42b3-aa66-ef2dc5b54fae"), new Guid("09a8afe4-d726-43f6-9878-41ca1a4d5b39"), "ZeroBugs", "It is impossible for developers to continuously produce bug-free, production ready code. Bugs will always exist. This article is about getting to a state of zero known bugs and that is absolutely possible.", new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Delete all the bugs from your backlog, now!", "Zero Bugs", "ZeroBugs" },
