        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("6181d9cc-ef13-42b3-aa66-ef2dc5b54fae"), "Andrew White", new Guid("09a8afe4-d726-43f6-9878-41ca1a4d5b39"), "ZeroBugs", "It is impossible for software engineers to continuously produce bug-free, production ready code. Bugs will always exist. This article is about how we effectively handle such issues, acheiving a state of zero bugs backlog.", new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Delete all the bugs from your backlog, now!", "Zero Bugs", "ZeroBugs" },
                    ...
                    { new Guid("d8632d22-eb92-41a6-b3c4-dc1235846084"), "Mark Pollard", new Guid("09a8afe4-d726-43f6-9878-41ca1a4d5b39"), "DevOpsCLI", "A container configured with all the CLI tools, scripts and extensions, a full stack DevOps cultured engineer needs for managing Azure environments resources such as AKS clusters.", new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 6, 18, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Azure Envs CLI container for DevOps teams", "Azure Envs CLI container", "devops-cli-azenvs" }
                });
