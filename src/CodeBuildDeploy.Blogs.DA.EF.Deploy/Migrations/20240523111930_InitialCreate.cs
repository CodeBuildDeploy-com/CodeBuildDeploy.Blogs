        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("d1ef2a8d-07bd-49cf-a785-a727567e9fc9"), new Guid("fc3cb34b-53c9-4342-a139-9ecf6b134008"), "WslAnsible", "Read how to setup Ansible on Windows Subsystem for Linux, including setting up for seamlessly calling from windows powershell.", new DateTime(2024, 4, 7, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 10, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Setting up Ansible on WSL", "Ansible on WSL", "WslAnsible" }
                });
